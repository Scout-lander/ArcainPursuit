...
//            base.Start();
        ...
        {
            string path = System.IO.Path.Combine(Application.persistentDataPath, "Save", "Character.json");
            try
            {
                System.IO.File.WriteAllText(path, Character.ToJson());
            ...
            catch (Exception e)
            {
                ...
                if (FilePathText != null)
                {
                    FilePathText.text = "Error saving file.";
                }
            }
        }
		...
		public void LoadFromJson()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (FilePathText != null)
                    {
                        FilePathText.text = "File not found.";
                    }
                }
            }
            catch (Exception e)
            {
                ...
                if (FilePathText != null)
                {
                    FilePathText.text = "Error loading file.";
                }
            }
        }
