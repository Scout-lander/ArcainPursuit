...
public abstract class Weapon : Skill
{
    ...
    protected WeaponData weaponData; // Declare weaponData
    ...
    public virtual void Initialise(WeaponData data)
    {
        ...
        ActivateCooldown();
        WeaponTime = GameManager.instance.stopwatchTime; // Set WeaponTime from GameManager
    ...
    private IEnumerator UpdateWeaponDPS()
    {
        while (true)
        {
            WeaponDPS = damageTotal / (GameManager.instance.stopwatchTime - WeaponTime);
