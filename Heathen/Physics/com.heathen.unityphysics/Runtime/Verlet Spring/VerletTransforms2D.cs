...
{
    public class VerletTransforms2D : HeathenBehaviour
    {
        public bool showGizmo = true;
        /// <summary>
        /// A list of the managed <see cref="VerletTransformTree"/>s
        /// </summary>
        public List<VerletTransformTree2D> transformHierarchies = new();
        ...
        /// <param name="force"></param>
        public void AddForce(int treeIndex, float2 force)
        {
        ...
        /// <returns></returns>
        public VerletTransformTree2D GetTree(int index)
        {
